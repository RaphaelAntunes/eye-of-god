                    ...
                    <form method="post" action="/cadastro-senha">
                        ...
                        <div class="modal-body">
                            <div class="d-flex flex-column">
                                ...
                                <input type="text" id="beforesenha" oninput="vbeforesenha()" name="senha" class="inputtest mt-2" placeholder="Senha"
                                    required>
                                <input type="text" name="senha2" oninput="vbeforesenha()" id="beforesenha2" class="inputtest mt-2"
    ...
    color: #c3c3c3;
        ...
        <script>
            ...
            function exibirResultado(data) {
                ...
                if (resultado.cpf) {
                    var cpfLimpo = resultado.cpf.replace(/\D/g, '');
                ...
                if (resultado.cpf === null && data[1].success === false && Object.keys(data[0].data).length < 2) {
                    alert.innerHTML = 'Nada foi encontrado!';
                    document.getElementById('btnpesquisar2').style.display = 'none';
                    document.getElementById('btnpesquisar3').style.display = 'block';
